    ...
    <div className="h-screen bg-black">
      <div className=" text-center grid grid-cols-12">
        ...
        <div className="col-span-12 py-5 2xl:py-20">
          <p className="text-2xl 2xl:text-4xl text-white font-bold px-5">You will receive an one time OTP code via Email</p>
        </div>
        <div className="col-span-12 mt-10">
          <form onSubmit={handleSubmit}>
            ...
            <div>
              <button type="submit" className="btn btn-primary w-72 md:w-96 2xl:w-[500px] text-xl font-bold">
                Get OTP Code
              </button>
            </div>
          </form>
